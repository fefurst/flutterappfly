...
class BGM {
  ...
  static Future<void> add(String filename) async {
    AudioCache newTrack = AudioCache(prefix: 'audio/', fixedPlayer: AudioPlayer(playerId: 'flutterappfly'));
  ...
  static Future play(int trackIndex) async {
    ...
    await _tracks[_currentTrack].loop(_tracks[_currentTrack].loadedFiles.keys.first);
